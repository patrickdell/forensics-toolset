...
async function runWatermarkChecks() {
  ...
  if (c2pa.present) {
    container.appendChild(card('success', 'C2PA / Content Credentials', 'Content Credentials detected',
      ...
      `<a href="https://verify.contentauthenticity.org/" target="_blank" rel="noopener">Content Authenticity Initiative Verify ↗</a> ` +
  ...
  container.appendChild(card('info', 'SynthID (Google DeepMind)', 'Cannot verify locally',
    ...
    '<a href="https://deepmind.google/technologies/synthid/" target="_blank" rel="noopener">About SynthID ↗</a> ' +
    '<em>(third-party)</em>'
  ));
